...
const collectCurrencies = () => {
  ...
  //   arrRa['RUB'] = { RUB: 1 }
  // }
  // // Создаем отдельный список валют для конвертации
  // arrCurrencies.value = Object.keys(arrRa)
}
    ...
    <form>
      <div>
        <select v-model="fromCurrency">
          <option v-for="currency in collectCurrencies" :key="currency" :value="currency">{{ currency.toUpperCase() }}</option>
        </select>
